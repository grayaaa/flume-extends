...
public class MultiLineParserModule implements Configurable, DirectoryTailParserModulable {
  private static final Logger logger = LoggerFactory.getLogger(MultiLineParserModule.class);
